          ...
          {step === 'success' ? (
            ...
            <div className="p-5 space-y-4">
              ...
              <div className="bg-gray-50 rounded-lg p-3 space-y-1">
                {items.map(i => (
                  <div key={`${i.productId}-${i.variantId || ''}`} className="flex justify-between text-xs text-gray-600">
              ...
              {items.length === 0 ? (
                ...
                <>
                  <div className="space-y-3 mb-4">
                    {items.map(item => (
                      <div key={`${item.productId}-${item.variantId || ''}`} className="flex items-center gap-3 bg-gray-50 rounded-lg p-3">
                        ...
                        <button onClick={() => removeItem(item.productId, item.variantId)} className="text-gray-300 hover:text-red-500"><Trash size={14} /></button>
                      </div>
                    ))}
                  </div>
