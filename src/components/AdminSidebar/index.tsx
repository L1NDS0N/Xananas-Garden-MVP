...
const AdminSidebar: React.FC = () => {
  ...
  return (
    <>
      {/* Desktop: vertical sidebar — scrolls with the page instead of being pinned, so it
          never clips its own links on a viewport shorter than the nav list */}
      <div className="hidden lg:flex flex-col min-h-[calc(100vh-56px)] w-56 bg-white border-r border-gray-200 pt-4">
