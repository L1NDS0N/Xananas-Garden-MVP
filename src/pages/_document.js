      ...
      <Head>
        ...
        <style dangerouslySetInnerHTML={{ __html: `
          ...
          .splash-logo-wrapper::before {
            ...
            inset: -10px;
            border-radius: 50%;
            background: conic-gradient(from 0deg, rgba(222,129,141,0.5), rgba(255,209,214,0.05), rgba(222,129,141,0.5));
            filter: blur(18px);
            animation: splashAuraSpin 6s linear infinite;
            z-index: 0;
          }
          ...
          .splash-logo-svg {
            width: 190px;
            height: 190px;
            filter: drop-shadow(0 10px 40px rgba(222,129,141,0.45));
